...
def create_import_table_config(id_token):
...
def create_import_column_config(id_token):
    endpoint = TAG_ENGINE_URL + '/create_import_config'
...
if __name__ == '__main__':
    ...
    response = create_import_table_config(id_token)
    ...
    response = create_import_column_config(id_token)
    response = trigger_job(id_token, response)
