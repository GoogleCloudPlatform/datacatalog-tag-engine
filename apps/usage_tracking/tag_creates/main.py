...
reporting_table = 'tag_creates' # designated name for the output table
...
def main(log_sync_project, log_sync_dataset, reporting_project, reporting_dataset, start_date:None):
    ...
    sql += "where protopayload_auditlog.methodName = 'google.cloud.datacatalog.v1.DataCatalog.CreateTag' "
